...
class Table extends React.Component {
    constructor() {
        ...
        this.renderRow = (item, rowIndex) => {
            ...
            const interactive = Boolean(!disabled && ((descriptor === null || descriptor === void 0 ? void 0 : descriptor.interactive) || onRowClick));
    ...
    renderTable() {
        ...
        return ((0, jsx_runtime_1.jsxs)("table", { ref: this.tableRef, className: b('table', { width }), children: [this.renderHead(), this.renderBody()] }));
    }
    renderEmptyRow() {
        const { columns, emptyMessage } = this.props;
        return ((0, jsx_runtime_1.jsx)("tr", { className: b('row', { empty: true }), children: (0, jsx_runtime_1.jsx)("td", { className: b('cell'), colSpan: columns.length, children: emptyMessage ? emptyMessage : (0, i18n_1.default)('label_empty') }) }));
    }
