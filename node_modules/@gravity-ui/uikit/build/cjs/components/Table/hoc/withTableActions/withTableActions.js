...
const DefaultRowActions = ({ index, item, getRowActions, getRowDescriptor, rowActionsSize, isRowDisabled, }) => {
    ...
    const renderPopupMenuItem = (action, index) => {
        ...
        return ((0, jsx_runtime_1.jsx)(Menu_1.Menu.Item, Object.assign({ onClick: (event) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: actionsCn, children: [(0, jsx_runtime_1.jsx)(Popup_1.Popup, { open: isPopupOpen, anchorRef: anchorRef, placement: DEFAULT_PLACEMENT, onOutsideClick: closePopup, id: rowId, children: (0, jsx_runtime_1.jsx)(Menu_1.Menu, { className: menuCn, size: rowActionsSize, children: actions.map(renderPopupMenuItem) }) }), (0, jsx_runtime_1.jsx)(Button_1.Button, { view: "flat-secondary", className: actionsButtonCn, onClick: togglePopup, size: rowActionsSize, ref: anchorRef, disabled: disabled, extraProps: {
                    'aria-label': (0, i18n_1.default)('label-actions'),
                    'aria-expanded': isPopupOpen,
                    'aria-controls': rowId,
                }, children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { data: icons_1.Ellipsis }) })] }));
};
    ...
    return _a = class extends React.Component {
            constructor() {
                ...
                this.renderBodyCell = (item, index) => {
                    ...
                    return ((0, jsx_runtime_1.jsx)(DefaultRowActions, { index: index, item: item, getRowActions: getRowActions, rowActionsSize: rowActionsSize, getRowDescriptor: getRowDescriptor, isRowDisabled: isRowDisabled }));
                };
            ...
            render() {
                ...
                return ((0, jsx_runtime_1.jsx)(TableComponent, Object.assign({}, restTableProps, { columns: this.enhanceColumns(columns), onRowClick: this.enhanceOnRowClick(onRowClick) })));
            }
        },
