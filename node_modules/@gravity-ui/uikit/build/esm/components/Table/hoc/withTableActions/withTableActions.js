...
const DefaultRowActions = ({ index, item, getRowActions, getRowDescriptor, rowActionsSize, isRowDisabled, }) => {
    ...
    const renderPopupMenuItem = (action, index) => {
        ...
        return (_jsx(Menu.Item, Object.assign({ onClick: (event) => {
    ...
    return (_jsxs("div", { className: actionsCn, children: [_jsx(Popup, { open: isPopupOpen, anchorRef: anchorRef, placement: DEFAULT_PLACEMENT, onOutsideClick: closePopup, id: rowId, children: _jsx(Menu, { className: menuCn, size: rowActionsSize, children: actions.map(renderPopupMenuItem) }) }), _jsx(Button, { view: "flat-secondary", className: actionsButtonCn, onClick: togglePopup, size: rowActionsSize, ref: anchorRef, disabled: disabled, extraProps: {
                    'aria-label': i18n('label-actions'),
                    'aria-expanded': isPopupOpen,
                    'aria-controls': rowId,
                }, children: _jsx(Icon, { data: Ellipsis }) })] }));
};
    ...
    return _a = class extends React.Component {
            constructor() {
                ...
                this.renderBodyCell = (item, index) => {
                    ...
                    return (_jsx(DefaultRowActions, { index: index, item: item, getRowActions: getRowActions, rowActionsSize: rowActionsSize, getRowDescriptor: getRowDescriptor, isRowDisabled: isRowDisabled }));
                };
            ...
            render() {
                ...
                return (_jsx(TableComponent, Object.assign({}, restTableProps, { columns: this.enhanceColumns(columns), onRowClick: this.enhanceOnRowClick(onRowClick) })));
            }
        },
